...
for index, img_dir in enumerate(img_dirs):
    ...
    plt.subplot(131)
    plt.scatter(H_b_texture[:,1], H_b_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('H Filter, Green Channel Texture')
    plt.subplot(132)
    plt.scatter(H_g_texture[:,1], H_g_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('H Filter, Red Channel Texture')
    plt.subplot(133)
    plt.scatter(H_r_texture[:,1], H_r_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
    plt.legend()
    ...
    plt.scatter(V_b_texture[:,1], V_b_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(132)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('V Filter, Green Channel Texture')
    plt.scatter(V_g_texture[:,1], V_g_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(133)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('V Filter, Red Channel Texture')
    plt.scatter(V_r_texture[:,1], V_r_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
    ...
    plt.scatter(P_b_texture[:,1], P_b_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(132)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('P Filter, Green Channel Texture')
    plt.scatter(P_g_texture[:,1], P_g_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(133)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('P Filter, Red Channel Texture')
    plt.scatter(P_r_texture[:,1], P_r_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
    ...
    plt.scatter(M_b_texture[:,1], M_b_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(132)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('M Filter, Green Channel Texture')
    plt.scatter(M_g_texture[:,1], M_g_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])

    plt.subplot(133)
    plt.xlabel('Dissimilarity')
    plt.ylabel('Correlation')
    plt.title('M Filter, Red Channel Texture')
    plt.scatter(M_r_texture[:,1], M_r_texture[:,3], marker=markers[index], label=labels[index], color=colors[index])
