        ...
        return (
            ...
            <div>
                ...
                <div className="webcam-control-container">
                    {!this.state.showSaveButtons ? <div className="button btn btn-primary" onClick={() => this.takePicture()}>Take Picture</div> : null}
                    {this.state.showSaveButtons ?
                        <div>
                            <div className="button btn btn-success" onClick={() => this.savePicture()}>Save Picture</div>
                            ...
                            <div className="button btn btn-warning" onClick={() => this.clearPicture()}>Clear Picture</div>
                        </div>
                    : null}
                </div>
            </div>
